...
public class UpdateSoilRecordRequest {
    ...
    @DecimalMax(value = "500.0", message = "Nitơ N phải nhỏ hơn hoặc bằng 500")
    ...
    @DecimalMax(value = "500.0", message = "Lân P phải nhỏ hơn hoặc bằng 500")
    ...
    @DecimalMax(value = "1000.0", message = "Kali K phải nhỏ hơn hoặc bằng 1000")
