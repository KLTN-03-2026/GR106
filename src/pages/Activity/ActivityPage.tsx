...
import { Construction, Sparkles, Activity, Hammer, Rocket } from 'lucide-react';
      ...
      >
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-black text-gray-900 tracking-tight leading-tight">
            Hoạt động hệ thống <br />
            <span className="text-emerald-600 italic">Tính năng này đang được phát triển</span>
          </h1>
          <p className="text-gray-500 text-lg font-medium leading-relaxed">
            Chúng tôi đang xây dựng hệ thống theo dõi và nhật ký hoạt động thông minh. <br />
